...
打印图片（*需要[安装](./GRAPHICSMAGICK.md)graphicsmagick*）
...
## 参数
`printText` 方法可以打印文本，参数为文本。

`printImage` 方法可以打印图片，参数按顺序依次为：

- `image`：本地图片路径，或网络图片地址，或base64格式图片数据
- `width`: 打印宽度，默认为384（咕咕机打印区总宽度）
