...
var Memobird = function () {
  ...
  (0, _createClass3.default)(Memobird, [{
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                showapi_userid = _ref4.showapi_userid;
    ...
    key: 'getPrintStatus',
    value: function () {
      var _ref5 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3(printcontentid) {
        var _ref6, printflag;
    ...
    key: 'glance',
    value: function () {
      var _ref7 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4(printcontentid) {
    ...
    key: 'watch',
    value: function () {
      var _ref8 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee5(printcontentid) {
    ...
    value: function () {
      var _ref9 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee6() {
        ...
        var printcontents, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, item, printcontent, _ref10, printcontentid;
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 37:
                ...
                printcontentid = _ref10.printcontentid;
    ...
    key: 'printText',
    value: function () {
      var _ref11 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee7(text) {
        return _regenerator2.default.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _context7.next = 2;
                return this.print(Memobird.encodeText(text));
    ...
    // 打印Canvas
    value: function () {
      var _ref12 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee8(canvas) {
        return _regenerator2.default.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                _context8.next = 2;
                return this.print(Memobird.encodeCanvas(canvas));
    ...
    // 根据图片路径打印
    value: function () {
      var _ref13 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee9(imagePath, width) {
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                _context9.t0 = this;
                _context9.next = 3;
                return Memobird.encodeImage(imagePath, width);
